...
class Overlay:
    ...
    def _build_home(self):
        ...
        heading = QHBoxLayout()
        heading.addWidget(_label("狗头军师", 23, "#24382d", True), 1)
        ...
        self.evidence.setTextInteractionFlags(Qt.TextSelectableByMouse)
        insight_box.addWidget(self.evidence)
        self.nextStep = _label("", 12, _MUTED)
        insight_box.addWidget(self.nextStep)
    ...
    def show(self, result):
        ...
        self.nextStep.setText("下一步 · " + reading.get("next_step", "") +
                              "\n停止条件 · " + reading.get("stop_condition", "") if reading else "")
        ...
        self.insight.setVisible(bool(self.cands) or bool(reading))
